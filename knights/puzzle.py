...
A_base_knowledge = And(Or(AKnave, AKnight), Not(And(AKnave, AKnight)))
B_base_knowledge = And(Or(BKnave, BKnight), Not(And(BKnave, BKnight)))
C_base_knowledge = And(Or(CKnave, CKnight), Not(And(CKnave, CKnight)))
...
# B says nothing.
knowledge1 = And(
    And(A_base_knowledge, B_base_knowledge),
    Or(
